...
function session(data) {
    if (data.seting != null) {
        var dt = $("#VisitanteGenerales-table").dataTable();
...
function init() {
    var campos = {
        "table_name": "VisitanteGenerales-table",
        "wrapper": "cover-VisitanteGenerales-table",
    ...
    $(document).on("click", ".edit-record", function () {
        ...
        seting = $('#VisitanteGenerales-table').dataTable().fnSettings();
