...
function init() {
    init_table({
        "table_name": "Compras-table",
        "wrapper": "cover-Compras-table",
        ...
        "cache_data": true,
        "cache_pages": 10,
        "url_get_data": url_compras_get_to_dt,
        "url_get_data_filtro": url_compras_get_to_dt_filtro,
        "export_data": true,
        "url_export_data": url_compras_export_data,
    ...
    $(document).on("click", ".edit-record", function () {
        ...
        seting = $('#Compras-table').dataTable().fnSettings();
...
$("#btnTipoCambio").on("click", function () {
    $("#tipoCambioActual").html(" $" + TipoCambio['TasaCambioUSD']);
    $('#change-tipoCambio-modal').modal({dismissible: false}).modal("open")
    $('#change-tipoCambio-modal').modal("open");
});

$("#save-tipoCambio").on("click", function () {
    $("#update-tasaCambio-form").submit();
});
