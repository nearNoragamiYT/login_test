...
namespace AdministracionGlobal\MainBundle\Controller;
...
class MainController extends Controller {
    ...
    protected $TextoModel, $DashboardModel, $idPlataformaIxpo = 1;
    ...
    public function indexAction(Request $request) {
        ...
        $modulos_usuario = $session->get("modulos_usuario");
        ...
        /* $content = array();
          ...
          $content['user'] = $user;
          return $this->render('AdministracionGlobalMainBundle:Main:index.html.twig', array('content' => $content)); */
    }
