...
namespace ShowDashboard\ST\MainBundle\Controller;
...
class MainController extends Controller {
    ...
    protected $TextoModel, $DashboardModel, $idPlataformaIxpo = 5;
    ...
    public function indexAction(Request $request) {
        ...
        /* Obtenemos textos de la sección de las estadisticas 8 */
        ...
        foreach ($modulos as $modulo) {
            ...
            if($modulo['idModuloIxpo']==78){
                 return $this->redirectToRoute('demographics_asociados');
            }
        }
        return $this->redirectToRoute('show_dashboard_edicion', array('idEdicion' => $edicion['idEdicion'], 'lang' => $lang));
    }
