...
namespace ShowDashboard\RS\VisitanteBundle\Controller;
...
use ShowDashboard\RS\VisitanteBundle\Model\VisitanteModel;
...
class VisitanteController extends Controller {
    ...
    public function visitorAction(Request $request) {
        ...
        return $this->render('ShowDashboardRSVisitanteBundle:Visitante:lista_visitante.html.twig', array('content' => $content));
    }
    ...
    public function exportVisitorDataAction(Request $request) {
        ...
        $response = $this->render('ShowDashboardRSVisitanteBundle:Visitante:generic_table.html.twig', array('header' => $header_report, 'subheader' => $subheader, 'columns' => $raw_columns, 'data' => $data));
